...
include("11_Est_R-V_R-Stress.jl")
include("12_Vol_R-Stress.jl")
include("15_Pot_R-R_R-Stress.jl")
#
...
function F_Obj(x::Array{Float64,1}, rho::Float64, mult_res::Array{Float64,1}, tipo::Int64,
   nnos::Int64, nel::Int64, ijk::Array{Int64,2}, ID::Array{Int64,2}, K0::Array{Float64,2},
         M0::Array{Float64,2}, SP::Float64, vmin::Float64, F::Array{Float64,1}, NX::Int64,
          ...
          raiof::Float64, Y0::Float64, caso::Int64, freq::Float64, alfa::Float64,
         beta::Float64, A::Float64, Ye::Float64, CBA::Array{Float64,3}, QP::Float64, filtra::Bool=true)

    # Caso Estático
    if caso == 1
        return F_Est(x, rho, mult_res, tipo, nnos, nel, ijk, ID, K0, M0, SP, vmin, F,
            NX, NY, vizi, nviz, dviz, raiof, Y0, caso, freq, alfa, beta, A, Ye, CBA, QP)
    ...
    elseif caso == 12
        return F_Vol_S(x, rho, mult_res, tipo, nnos, nel, ijk, ID, K0, M0, SP, vmin, F,
            NX, NY, vizi, nviz, dviz, raiof, Y0, caso, freq, alfa, beta, A, Ye, CBA, QP)

    elseif caso == 15
        return F_Pot_R_R_R_Stress(x, rho, mult_res, tipo, nnos, nel, ijk, ID, K0, M0, SP, vmin, F,
            NX, NY, vizi, nviz, dviz, raiof, Y0, caso, freq, alfa, beta, A, Ye, CBA, QP)
