...
#
function F_Obj2(x::Array{Float64,1}, rho::Array{Float64,1}, mult_res::Array{Float64,1}, tipo::Int64, nnos::Int64, nel::Int64,
  ...
  Nor = 100.0 + 10.0*log10(Nor1)
   ...
   # Flexibilidade estática
    ...
    if tipo == 1
        ...
        # Calcula densidade das colunas para verificar vazios
        soma_i = zeros(NX)
        for ele=1:nel
        ...
        # Verifica o produtório pra ver se tem algum buraco
        X_h = prod(soma_i)
        @show(X_h)
