...
#
# Define o Função Objetivo de Potência com restrição estática
#
function F_Pot_R_Est(x::Array{Float64,1}, rho::Float64, mult_res::Array{Float64,1}, tipo::Int64,
    ...
    elseif tipo == 3
        ...
        @inbounds for j=1:nel
            ...
            # Derivada da Flexibildiade Estática
            dSdx = -0.5*real(transpose(USe)*dKedx*USe)/Y0[2]

            # Derivada do LA
            dL[j] = dPBdx + dL1 + dL2*dSdx
