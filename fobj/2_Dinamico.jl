################################################################################
#####                       Flebixilidade Dinâmica                        ######
################################################################################

#
# Define o Função Objetivo de Flexibilidade Dinâmica
#
function F_Din(x::Array{Float64,1}, rho::Float64, mult_res::Array{Float64,1}, tipo::Int64,
   ...
   if filtra
    ...
    # Módulo da Flexibilidade Dinamica
